...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (1, 'Aptchaoligui', 'Perna sobe reta e desce reta', 10, 2, 1, 'sound/hapkido/branca/aptchaoligui.wav');
...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (1, 'Aptcha Nagagui', 'Três Aptchagui (em baixo, no meio e em cima)', 15, 3, 1, 'sound/hapkido/branca/aptchanagagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (1, 'Aptcholhô Nagagui', 'Três Aptcholhô Tchagui (em baixo, no meio e em cima)', 15, 3, 1, 'sound/hapkido/branca/aptcholhonagagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (1, 'Tchariô....Tchumbi', 'Atenção - Prepara', 0, 0, 0, 'sound/hapkido/comum/tchario_tchumbi.wav');
...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Aptchagô Duban Terigui', 'Aptchagui + 2 socos + base Kimá', 20, 2, 1, 'sound/hapkido/amarela/aptchagodubanterigui.wav');
...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Radan Yop Tchagui', 'Chute lateral baixo', 15, 4, 1, 'sound/hapkido/amarela/radanyoptchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Tchodan Yop Tchagui', 'Chute lateral médio', 10, 5, 1, 'sound/hapkido/amarela/tchodanyoptchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Sandan Yop Tchagui', 'Chute lateral alto', 10, 5, 1, 'sound/hapkido/amarela/sandanyoptchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Aptchagô Yop Tchagui', 'Aptchagui + Yop Tchagui', 10, 4, 1, 'sound/hapkido/amarela/aptchagoyoptchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Yop Tchanagagui', 'Vai buscar o adversário com 2 yop tchagui', 10, 6, 1, 'sound/hapkido/amarela/yoptchanagagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Antchagui', 'Arco de 180 graus com a perna de trás', 10, 5, 1, 'sound/hapkido/amarela/antchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Tchariô....Tchumbi', 'Atenção - Prepara', 0, 0, 0, 'sound/hapkido/comum/tchario_tchumbi.wav');
...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (2, 'Yoppalkut', 'Cotovelada em base Tchungo', 15, 3, 1, 'sound/hapkido/amarela/yoppalkut.wav');
...
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (3, 'TigoTchagui', '', 25, 2, 1, 'sound/hapkido/amarelaponteiraverde/tigotchagui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (3, 'TicunTicha Dolligui', '', 10, 5, 1, 'sound/hapkido/amarelaponteiraverde/ticuntichadoligui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (3, 'TicunTicha Nerigui', '', 10, 5, 1, 'sound/hapkido/amarelaponteiraverde/ticuntichanerigui.wav');
INSERT INTO movimento (id_faixa, descricao, observacao, qtd_repeticao, intervalo_segundos, eh_golpe, voz_path) VALUES (3, 'Bakatari', '', 15, 3, 1, 'sound/hapkido/amarelaponteiraverde/bakatari.wav');
